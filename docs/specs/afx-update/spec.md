...
| FR-4 | `apply` runs upstream installer update flow (`afx-cli --update`) with supported pass-through flags            | P1       |
...
| NFR-4 | Keep Claude/Codex behavior aligned via canonical source of truth in `skills/`                | P1       |
