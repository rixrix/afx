...
- [x] 1.2 Update `install.sh` to create `docs/adr/` in target projects
...
| 2026-02-24 | 3.1-3.3       | VERIFIED                         | Docs reviewed: prompts/, .afx.yaml.template, install.sh also updated | [x]  | [x]  |
